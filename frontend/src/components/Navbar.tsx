...
const Navbar = () => {
    ...
    return (
        <header className={`navbar ${scrolled ? 'scrolled' : 'not-scrolled'}`}>            <div className="inner">                  <Link to="/" className="logo">
            <div className="flex flex-row items-center gap-1 hover:opacity-80 transition-opacity duration-200">
                <div className="flex items-baseline">
                    <span className="text-2xl font-extrabold text-gray-800 tracking-tight">Fluenzy</span>
                    <span className="text-2xl font-bold text-primary ml-0.5 relative">.in</span>
                </div>
            </div>
        </Link>
